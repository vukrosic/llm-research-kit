"""
Run batch 4: 15 GatedMHConv exploitation variants, 5 min each.
"""
...
import frontier.architectures.novel_noattn_v4
...
RESULTS_DIR = ROOT / "frontier_results" / "novel_v4"
...
def main():
    ...
    experiments = sorted([k for k in list_architectures() if k.startswith('V4_')])
    print(f"V4 batch: {len(experiments)} architectures, {TIME_BUDGET}s each")
    ...
    print(f"\n{'='*70}")
    print(f" V4 RESULTS (5min, d=512, L=22)")
