"""
Run batch 12: Breaking the plateau — new paradigms, 5 min each.
"""
...
import frontier.architectures.novel_noattn_v12
...
RESULTS_DIR = ROOT / "frontier_results" / "novel_v12"
...
def main():
    ...
    experiments = sorted([k for k in list_architectures() if k.startswith('V12_')])
