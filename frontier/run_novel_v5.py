"""
Run batch 5: 15 radical non-attention architectures, 5 min each.
"""
...
import frontier.architectures.novel_noattn_v5
...
RESULTS_DIR = ROOT / "frontier_results" / "novel_v5"
...
def main():
    ...
    experiments = sorted([k for k in list_architectures() if k.startswith('V5_')])
    print(f"V5 batch: {len(experiments)} architectures, {TIME_BUDGET}s each")
    ...
    print(f"\n{'='*70}")
    print(f" V5 RESULTS (5min, d=512, L=22)")
