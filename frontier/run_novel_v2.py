...
import frontier.architectures.novel_noattn_v2
...
RESULTS_DIR = ROOT / "frontier_results" / "novel_v2"
...
def main():
    ...
    experiments = sorted([k for k in list_architectures() if k.startswith('V2_')])
    ...
    print(f" Baselines: transformer=3.784, PureConv=3.920, best_v1=4.004")
    print(f"{'='*70}")
