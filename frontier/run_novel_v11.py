"""
Run batch 11: Beyond the plateau — novel mechanisms, 5 min each.
"""
...
import frontier.architectures.novel_noattn_v11
...
RESULTS_DIR = ROOT / "frontier_results" / "novel_v11"
...
def main():
    ...
    experiments = sorted([k for k in list_architectures() if k.startswith('V11_')])
